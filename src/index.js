...
import { createCard, likeCardFunction, deleteCardFunction } from "./components/card.js";
import { openModalWindow, closeModalWindow } from "./components/modal.js";
import { enableValidation, clearValidation } from "./components/validation.js";
import { getUserData, getInitialCards, editProfileData, addNewCard, updateAvatar } from "./components/api.js";
...
function handleNewCardFormSubmit(evt) {
    ...
    addNewCard(card.name, card.link)
        .then((card) => {
            ...
            const newCard = createCard(card, deleteCardFunction, openPopupTypeImage, likeCardFunction, ownerId);
...
Promise.all([getUserData(), getInitialCards()])
    .then(([userData, cardData]) => {
        ...
        cardData.forEach((cardItem) => {
            const listItem = createCard(cardItem, deleteCardFunction, openPopupTypeImage, likeCardFunction, ownerId);
